...
export const MapSection = (): JSX.Element => {
  return (
    <section id="coverage" className="relative w-full min-h-screen bg-white flex items-center justify-center py-8 md:py-10 lg:py-12 px-4 md:px-6 lg:px-4">
        ...
        <div className="flex flex-col items-start gap-8 md:gap-10 lg:gap-12 flex-1">
          <div className="flex flex-col items-center justify-center gap-4 md:gap-5 lg:gap-[21px] w-full">
            ...
            >
              <Badge
                variant="outline"
                className="inline-flex items-center justify-center gap-2.5 px-3 py-2 md:px-4 md:py-2.5 bg-white rounded-full border-2 border-[#e4e4e4] hover:border-[#fe0000] hover:bg-[#fff5f5] transition-all duration-300 shadow-sm hover:shadow-md cursor-pointer"
              >
            ...
            >
              <motion.span
                ...
                className="text-[#fe0000] tracking-[0] inline-block"
              >
                PAN-INDIA
              </motion.span>
