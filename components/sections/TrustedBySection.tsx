...
export default function TrustedBySection() {
  return (
    <section id="trusted-by" className="w-full bg-[#f6f6f6] py-12 md:py-16 lg:py-24 overflow-hidden">
            ...
            {[...Array(3)].map((_, setIndex) => (
              ...
              >
                {logoStrip1.map((logo, idx) => (
                  <div
                    key={`strip1-${setIndex}-${idx}`}
                    className="flex-shrink-0 w-[100px] h-[50px] md:w-[140px] md:h-[70px] lg:w-[180px] lg:h-[90px] flex items-center justify-center transition-all duration-300"
                  >
                    <Image
                      src={logo}
                      alt="Client logo"
