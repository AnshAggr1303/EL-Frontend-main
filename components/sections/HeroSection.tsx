...
export default function HeroSection() {
  return (
    <section id="home" className="relative w-full min-h-[85vh] bg-[#F5F7FA] overflow-hidden">
          ...
          <div className="flex flex-col gap-5 sm:gap-6 max-w-xl">
            ...
            >
              <img
                ...
                className="w-[90px] h-[90px] sm:w-[105px] sm:h-[105px] rounded-full object-contain bg-transparent"
              />
              <img
      ...
      >
        <img
          ...
          className="w-full max-w-[1080px] mx-auto object-contain lg:translate-y-[10%]"
        />
      </motion.div>
    </section>
  );
